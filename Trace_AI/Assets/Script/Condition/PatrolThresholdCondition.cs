using UnityEngine;
using System.Linq;
public class PatrolThresholdCondition : StateCondition
{
    ...
    public override bool ExitCondition()
    {
        ...
        if (isBelow)
        {
            return ai.targetList.First().Value <= patrolThreshold; // 이하인 경우
        }
        else
        {
            return ai.targetList.First().Value > patrolThreshold; // 이상인 경우
        }
    }
}
